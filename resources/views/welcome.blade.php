                                ...
                                <div class="container-fluid">
                                    <div class="c-qaCard">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <img class="c-qaCard__icon"
                                                    src="{{ asset('uploads/images/yzl-test.png') }}" alt="icons">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    <div class="c-qaCard">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <img class="c-qaCard__icon"
                                                    src="{{ asset('uploads/images/yzl-school.png') }}" alt="icons">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    <div class="c-qaCard">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <img class="c-qaCard__icon"
                                                    src="{{ asset('uploads/images/yzl-campus.png') }}" alt="icons">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    <div class="c-qaCard">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <img class="c-qaCard__icon"
                                                    src="{{ asset('uploads/images/yzl-club.png') }}" alt="icons">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    <div class="c-qaCard">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <img class="c-qaCard__icon"
                                                    src="{{ asset('uploads/images/yzl-coop.png') }}" alt="icons">
                                            </div>
                                        </div>
                                    </div>
                                </div>
