    ...
    <div class="l-header-navBar container col-10">
        ...
        <div class="l-header_navItems collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="l-header_ul navbar-nav">
                <li class="l-header_li nav-item"><a class="nav-link scrollFunction" href="{{route('senior')}}">學長姐｜快找</a></li>
                <li class="l-header_li nav-item"><a class="nav-link scrollFunction" href="{{route('study-abroad')}}">留學誌｜推薦</a></li>
                @if(auth()->check())
                    <li class="l-header_li nav-item"><a class="nav-link scrollFunction" href="{{route('home')}}">易子學系統</a></li>
                ...
                @else
                    <li class="l-header_li nav-item"><a class="nav-link scrollFunction" href="{{route('login')}}">註冊｜登入</a></li>
                    <li class="l-header_li nav-item">
                        <svg class="l-header_thumbNail" viewbox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
